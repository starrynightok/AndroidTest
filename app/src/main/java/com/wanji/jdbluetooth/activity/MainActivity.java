    ...
    public final class ItemClick implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View arg1, int position, long id) {
            if (BluetoothClient.getCurInstance() != null) {
                CommonFunctions.Msg(MainActivity.this, "请断开蓝牙");
                return;
            }
            GlobalVariables.gCurBluetoothDevice = GlobalVariables.gListBluetoothDevice.get((int) id);
            try {
                dia_bluetooth = ProgressDialog.show(MainActivity.this, "提示", "正在连接，请稍后...");
                ...
                CommonFunctions.Msg(MainActivity.this, "连接蓝牙异常");
            }
        }
    }
    ...
    public void bluetoothClick(View v) {
        ...
        if (btn_bluetooth_flag) {
            ...
            if (GlobalVariables.gBluetoothAdapter == null) {
                CommonFunctions.Msg(MainActivity.this, "当前设备不支持蓝牙");
                return;
            }
            if (!GlobalVariables.gBluetoothAdapter.isEnabled()) {
                CommonFunctions.Msg(MainActivity.this, "请开启蓝牙");
                return;
            }
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothDevice.ACTION_FOUND.equals(action)) {//每扫描到一个设备，系统都会发送此广播。
             ...
             //   }
                ...
                dia_bluetooth = ProgressDialog.show(MainActivity.this, "提示", "搜索中...");
            } else if (BluetoothAdapter.ACTION_DISCOVERY_FINISHED.equals(action)) {
                dia_bluetooth.cancel();
                CommonFunctions.Msg(MainActivity.this, "搜索完毕");
        ...
        public void handleMessage(Message msg) {
            ...
            try {
                ...
                if ("0".equals(msgId)) {//连接成功
                    CommonFunctions.Msg(MainActivity.this, msg.getData().getString("msgContent").toString());
                    dia_bluetooth.cancel();
                    Intent i = new Intent(MainActivity.this, DeviceSelectActivity.class);
                    startActivity(i);
